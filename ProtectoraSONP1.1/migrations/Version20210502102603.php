 ...
 */
final class Version20210502102603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE revision (id INT AUTO_INCREMENT NOT NULL, ficha_id INT DEFAULT NULL, fecha DATE DEFAULT NULL, diagnostico VARCHAR(255) DEFAULT NULL, INDEX IDX_6D6315CC5030B25F (ficha_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
